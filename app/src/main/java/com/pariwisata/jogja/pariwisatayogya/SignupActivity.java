...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CoordinatorLayout myLayout = findViewById(R.id.signup_layout);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    ...
                    alert.show();
//                    Toast.makeText(getApplicationContext(), R.string.email_null, Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                    Toast.makeText(getApplicationContext(), R.string.password_null, Toast.LENGTH_SHORT).show();
                ...
                if (password.length() < 6) {
                    builder.setMessage(R.string.minimum_password);
                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // Do nothing but close the dialog
                            dialog.dismiss();
    ...
    private void resetPassword() {
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(getApplication(), R.string.forgot_password_msg, Toast.LENGTH_SHORT).show();
                    return;
                }
